    ...
    return (
        <div className="">
            ...
            <div className={"absolute z-10 bottom-0 w-screen bg-zinc-700 rounded-t-2xl p-4 " + ReelShareStyles['reel-share-container'] }>
                <input
                    className={"mt-8 placeholder:text-gray-500 placeholder:text-lg text-white block bg-zinc-800 w-full rounded-lg py-2 px-4 focus:outline-none " + ReelShareStyles["reel-share-input"]}
                    placeholder="Search"
                    type="text"
                    name="search"
                ></input>
                    ...
                    following.map(user => (
                        user && (
                            <div className="flex py-3 items-center">
                                ...
                                <button
                                    className={"text-white text-sm py-1 px-3 rounded " + (sentTo.includes(user._id) ? "bg-gray-500 " : "bg-blue-500 ")}
